...
export const locales = {
  en: {
    ...
    termsIntro:
      "By using Sanatan AI, you agree to the following terms and conditions:",
    termsList1:
      "This AI is for informational and educational purposes related to Sanatan Dharma.",
    termsList2:
      "The information provided may not always be 100% accurate. Please consult with qualified spiritual teachers for profound matters.",
    termsList3:
      "Do not use this service for any illegal or malicious activities.",
    termsList4: (
      <>
    ...
    termsList6:
      "Your conversations may be used anonymously to improve the AI model.",
  ...
  hi: {
    ...
    termsIntro:
      "Sanatan AI का उपयोग करके, आप निम्नलिखित नियमों और शर्तों से सहमत होते हैं:",
    termsList1:
      "यह एआई सनातन धर्म से संबंधित जानकारी और शैक्षिक उद्देश्यों के लिए है।",
    termsList2:
      "प्रदान की गई जानकारी हमेशा 100% सही नहीं हो सकती। गहरी समझ के लिए योग्य आध्यात्मिक शिक्षकों से परामर्श करें।",
    termsList3:
      "कृपया किसी भी अवैध या दुष्ट गतिविधियों के लिए इस सेवा का उपयोग न करें।",
    termsList4: (
      <>
    ...
    termsList5: (
      <>
        एनिमेटेड आइकन <a href="https://lordicon.com">LordIcon</a> से हैं
      </>
    ),
    termsList6:
      "आपकी बातचीत को मॉडेल सुधारने के लिए गुमनाम रूप से उपयोग किया जा सकता है।",
    termsList7:
